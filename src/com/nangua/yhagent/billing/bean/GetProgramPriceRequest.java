...
public class GetProgramPriceRequest {
	...
	public GetProgramPriceRequest setRequestInfo(RequestInfo requestInfo) {
	...
	public GetProgramPriceRequest setAuth(Auth auth) {
		this.auth = auth;
		return this;
	}
	...
	public GetProgramPriceRequest setService(Service service) {
